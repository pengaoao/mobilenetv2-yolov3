...
class objDetNet(nn.Module):
    def __init__(self,opt):
        ...
        self.yolo13 = yoloOutputAndLoss([(116, 90), (156, 198), (373, 326)], 1, self._opt.imgSquareSize)
        self.yolo26 = yoloOutputAndLoss([(30, 61), (62, 45), (59, 119)], 1, self._opt.imgSquareSize)
        self.yolo52 = yoloOutputAndLoss([(10, 13), (16, 30), (33, 23)], 1, self._opt.imgSquareSize)
